...
import transactionSourceMetadataSql from './035_transaction_source_metadata.sql?raw';
...
export const MIGRATIONS: Migration[] = [
  ...
  { version: 35, name: '035_transaction_source_metadata',            sql: transactionSourceMetadataSql },
];
